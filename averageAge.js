const teamMembers = [
  ...
  const sumMembersAge = teamMembers.reduce((acc, members) => acc + members.age, 0)
  
  const averageMembersAge = sumMembersAge / teamMembers.length

  console.log(`The average age of team members is: ` + averageMembersAge);
